...
<head>
    ...
    <link rel="stylesheet" href="{{asset ('mazer-main/dist/assets/vendors/iconly/bold.css')}}">
    ...
    <link rel="shortcut icon" href="{{asset ('mazer-main/dist/assets/images/favicon.svg')}}" type="image/x-icon">
</head>
